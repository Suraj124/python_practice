...
class ThreeSeries(BMW):
    def __init__(self,cruiseControlEnabled,make,model,year):
        super().__init__(make,model,year)        #we can use super to use parent class constructor and we dont nedd to use self 
        self.cruiseControlEnabled=cruiseControlEnabled

    def display(self):
        print("Cruise control is enabled")

    def start(self):    # over riding the strat method
        super().start()
        print("Starting the cruise")
